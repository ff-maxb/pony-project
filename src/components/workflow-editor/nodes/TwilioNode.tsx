...
interface TwilioNodeData {
  kind: string;
  name: string;
  inputs: Record<string, unknown>;
}

export default function TwilioNode({
  data,
  selected,
}: {
  data: TwilioNodeData;
  ...
  const actionLabel = data.kind === "twilio_send_sms" ? "Send SMS" : data.name;
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5">
        ...
        <p className="text-xs font-semibold text-zinc-800 dark:text-zinc-100">SMS</p>
      </div>
